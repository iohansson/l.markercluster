describe('zoomAnimation', function () {
  ...
  // SETUP FOR EACH TEST
  /////////////////////////////
  var div; var map; var group; var clock; var realBrowser;
  ...
  it('removes clicked clusters on the edge of a mobile screen', function () {
    ...
    try {
      ...
      var bottomLatLng = map.unproject(bottomPoint);
      var centerLng = map.getCenter().lng;
      var bottomPosition = new L.LatLng(
        bottomLatLng.lat,
        centerLng,
      );
      var bottomMarker = new L.Marker(bottomPosition).addTo(group);
