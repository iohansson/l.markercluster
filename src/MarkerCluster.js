...
import {
  includeClusterSpiderfier,
  getExtendedWithoutAnimation as makeNotAnimated,
} from './MarkerCluster.Spiderfier';
import {
  includeQuickHull,
} from './MarkerCluster.QuickHull';
...
const MarkerCluster = Marker.extend({
  ...
  _recalculateBounds() {
    ...
    let latSum = 0;
    let lngSum = 0;
    let totalCount = this._childCount;
    let i;
    let child;
    let childLatLng;
    let childCount;
...
includeClusterSpiderfier(MarkerCluster);
includeQuickHull(MarkerCluster);

export { MarkerCluster };

export const MarkerClusterNonAnimated = makeNotAnimated(MarkerCluster);
