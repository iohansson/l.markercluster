...
import { includeClusterGroupSpiderfier } from './MarkerCluster.Spiderfier';
import { includeRefresh } from './MarkerClusterGroup.Refresh';

/*
 * MarkerClusterGroup extends FeatureGroup by clustering the markers contained within
 */
const MarkerClusterGroup = FeatureGroup.extend({
  options: {
  ...
  _bindEvents() {
    ...
    var spiderfyOnEveryZoom = this.options.spiderfyOnEveryZoom;
...
includeClusterGroupSpiderfier(MarkerClusterGroup);
includeRefresh(MarkerClusterGroup);

export { MarkerClusterGroup };

export const markerClusterGroup = options => new MarkerClusterGroup(options);
